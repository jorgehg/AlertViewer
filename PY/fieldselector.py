...
class FieldSelector(object):
    ...
    def setFields(self):
        ...
        self.fieldListStatus[2] = 1 if self.checkBox_ID_Usuario.isChecked() else 0
        self.fieldListStatus[3] = 1 if self.checkBox_Endpoint.isChecked() else 0
        self.fieldListStatus[4] = 1 if self.checkBox_BU.isChecked() else 0
        ...
        self.fieldListStatus[7] = 1 if self.checkBox_CanalDLP.isChecked() else 0
        self.fieldListStatus[8] = 1 if self.checkBox_Count.isChecked() else 0
        self.fieldListStatus[9] = 1 if self.checkBox_Severidad.isChecked() else 0
        self.fieldListStatus[10] = 1 if self.checkBox_AccionDLP.isChecked() else 0
        self.fieldListStatus[11] = 1 if self.checkBox_Escalamiento.isChecked() else 0
        self.fieldListStatus[12] = 1 if self.checkBox_CC.isChecked() else 0
        self.fieldListStatus[13] = 1 if self.checkBox_ArgosCapa.isChecked() else 0
    ...
    def switcher(self):
        ...
        self.checkBox_ID_Usuario.setChecked(self.switcher)  
        ...
        self.checkBox_CanalDLP.setChecked(self.switcher)  
        self.checkBox_Count.setChecked(self.switcher)
        self.checkBox_Severidad.setChecked(self.switcher)  
        self.checkBox_AccionDLP.setChecked(self.switcher) 
        self.checkBox_Escalamiento.setChecked(self.switcher)  
        self.checkBox_CC.setChecked(self.switcher)  
        self.checkBox_ArgosCapa.setChecked(self.switcher)  
    ...
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.pushButtonAplicar, 5, 2, 1, 1)
        self.pushButtonSwitch = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.pushButtonSwitch.setObjectName("pushButton")
        self.gridLayout.addWidget(self.pushButtonSwitch, 5, 0, 1, 1)
